...
// One entry per *moving* layer: the variable it drives, how much of the scroll
// offset it takes, and the tile height its offset wraps against. The furthest
// layer, .layer0, is at infinity and takes no offset, so it is absent here --
// it is pure CSS.
//
...
const LAYERS = [
  { name: "--parallax-1", cycles: "--parallax-cycles-1", rate: 0.05, tileHeight: 768 },
  { name: "--parallax-3", cycles: "--parallax-cycles-3", rate: 0.1, tileHeight: 1024 },
  { name: "--parallax-5", cycles: "--parallax-cycles-5", rate: 0.2, tileHeight: 1152 },
] as const;
